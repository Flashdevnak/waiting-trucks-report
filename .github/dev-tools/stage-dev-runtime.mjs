...
function unifiedHeaderHtml(currentPage) {
  ...
  return `<header class="site-header dev-unified-header" data-dev-shell="20260905-v2"><div class="site-header-inner"><div class="header-brand"><div class="brand-mark brand-f" aria-label="Flash"><span>F</span></div><div class="brand-copy"><strong${titleId}>${meta.title}</strong>${meta.clock}</div></div><nav class="topbar-actions dev-unified-actions" aria-label="เมนูหลัก"><div class="dev-shell-slot dev-shell-status">${meta.status}</div><div class="dev-shell-slot dev-system-nav"><details class="app-nav"><summary><span class="nav-grid-icon" aria-hidden="true"><svg class="dev-nav-svg" viewBox="0 0 24 24"><path d="M5 6h14M5 12h14M5 18h14"/></svg></span><span>เมนูระบบ</span><small>${currentLabel}</small></summary><div class="app-nav-menu">${navHtml(currentPage)}</div></details></div><div class="dev-shell-slot dev-page-tools"><details class="app-nav"><summary><span class="nav-grid-icon" aria-hidden="true"><svg class="dev-nav-svg" viewBox="0 0 24 24"><path d="M14.5 5.5l4 4M13.5 6.5l-8 8a2.1 2.1 0 0 0 3 3l8-8M16.5 15.5l2 2"/></svg></span><span>เครื่องมือ</span><small>หน้านี้</small></summary><div class="app-nav-menu dev-tools-menu">${meta.tools}</div></details></div><div class="dev-shell-slot dev-shell-refresh">${meta.refresh}</div><div class="dev-shell-slot dev-account-menu"><details class="app-nav"><summary><span class="nav-grid-icon" aria-hidden="true"><svg class="dev-nav-svg" viewBox="0 0 24 24"><circle cx="12" cy="8" r="3.2"/><path d="M5.5 19c1.4-3.8 3.8-5.8 6.5-5.8s5.1 2 6.5 5.8"/></svg></span><span>บัญชี</span><small>สิทธิ์ผู้ใช้</small></summary><div class="app-nav-menu dev-tools-menu">${meta.account}</div></details></div></nav></div></header>`;
}
