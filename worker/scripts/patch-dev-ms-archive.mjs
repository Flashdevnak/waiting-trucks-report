...
export function patchDevMsMobileStyle(source) {
  ...
  return `${output.trimEnd()}\n\n${DEV_MOBILE_SPACING_MARKER}\n@media (max-width: 900px) {\n  .ms-page .compact-schedule {\n    padding: 14px 14px 16px;\n    border-bottom: 0;\n    background: #f4f5f2;\n  }\n  .ms-page .compact-schedule .schedule-section + .schedule-section {\n    margin-top: 12px;\n  }\n  .ms-page .compact-operation {\n    margin: 0 14px 14px;\n    border: 1px solid #d9dcd8;\n    border-radius: 8px;\n    overflow: hidden;\n  }\n  .ms-page .departure-countdown {\n    width: auto;\n    margin: 0 14px 14px;\n  }\n  .ms-page .arrival-sources,\n  .ms-page .source-empty {\n    width: auto;\n    margin: 0 14px 14px;\n  }\n  .ms-page .compact-party {\n    margin-top: 2px;\n    padding: 16px 14px;\n    border-top: 1px solid #d9dcd8;\n  }\n}\n\n@media (max-width: 420px) {\n  .ms-page .compact-operation,\n  .ms-page .departure-countdown,\n  .ms-page .arrival-sources,\n  .ms-page .source-empty {\n    margin-left: 11px;\n    margin-right: 11px;\n  }\n  .ms-page .compact-schedule {\n    padding: 12px 11px 14px;\n  }\n}\n\n${DEV_MOBILE_SHELL_MARKER}\n.dev-unified-header .app-nav-menu a>b { color:#fff !important; opacity:1 !important; }\n.dev-unified-header .app-nav-menu a>small { color:#d9dde0 !important; opacity:1 !important; }\n.dev-unified-header .app-nav-menu a.is-current>b { color:#fff !important; }\n.dev-unified-header .app-nav-menu a.is-current>small { color:#f0f1f2 !important; }\n.dev-unified-header .app-nav-menu a.is-current { background:#343434 !important; border-color:#d7b600 !important; box-shadow:inset 4px 0 #ffd400 !important; }\n@media (max-width: 700px) {\n  .dev-unified-header { position:relative !important; overflow:visible !important; }\n  .dev-unified-header .site-header-inner,\n  .dev-unified-header .dev-unified-actions { overflow:visible !important; }\n  .dev-unified-header .site-header-inner { padding:9px 10px 10px !important; gap:9px !important; }\n  .dev-unified-header .dev-unified-actions { width:100% !important; margin-left:0 !important; display:grid !important; grid-template-columns:minmax(0,1fr) minmax(0,1fr) !important; gap:7px !important; padding:0 !important; border:0 !important; background:transparent !important; }\n  .dev-unified-header .dev-utility-group { grid-column:1/-1 !important; grid-row:1 !important; width:100% !important; display:grid !important; grid-template-columns:minmax(0,1fr) auto !important; gap:7px !important; margin:0 !important; }\n  .dev-unified-header .dev-system-nav { grid-column:1 !important; grid-row:2 !important; }\n  .dev-unified-header .dev-page-tools { grid-column:2 !important; grid-row:2 !important; }\n  .dev-unified-header .dev-account-menu { grid-column:1/-1 !important; grid-row:3 !important; }\n  .dev-unified-header .dev-shell-slot,\n  .dev-unified-header .dev-shell-slot>* { min-width:0 !important; max-width:100% !important; }\n  .dev-unified-header .app-nav { position:static !important; width:100% !important; min-width:0 !important; }\n  .dev-unified-header .app-nav>summary { width:100% !important; min-width:0 !important; min-height:50px !important; grid-template-columns:30px minmax(0,1fr) 24px !important; gap:7px !important; padding:7px 9px !important; }\n  .dev-unified-header .app-nav>summary>span:nth-child(2) { min-width:0 !important; font-size:14.5px !important; line-height:1.2 !important; white-space:nowrap !important; overflow:hidden !important; text-overflow:ellipsis !important; }\n  .dev-unified-header .app-nav>summary small { display:none !important; }\n  .dev-unified-header .app-nav-menu { position:absolute !important; left:10px !important; right:10px !important; top:calc(100% + 6px) !important; bottom:auto !important; width:auto !important; max-width:none !important; max-height:calc(100dvh - 235px) !important; margin:0 !important; overflow-y:auto !important; overflow-x:hidden !important; overscroll-behavior:contain !important; z-index:999 !important; }\n  .dev-unified-header .app-nav-menu a { grid-template-columns:44px minmax(0,1fr) !important; column-gap:12px !important; min-height:68px !important; padding:11px 12px !important; }\n  .dev-unified-header .app-nav-menu a>span { width:42px !important; height:42px !important; }\n  .dev-unified-header .app-nav-menu a>b { font-size:15px !important; line-height:1.3 !important; }\n  .dev-unified-header .app-nav-menu a>small { font-size:12px !important; line-height:1.35 !important; }\n  .dev-unified-header .dev-utility-group .dev-shell-status>.badge { width:100% !important; min-width:0 !important; min-height:44px !important; padding:8px 10px !important; font-size:12px !important; white-space:nowrap !important; word-break:keep-all !important; overflow:hidden !important; text-overflow:ellipsis !important; justify-content:center !important; }\n  .dev-unified-header .dev-utility-group .dev-shell-refresh>.btn { min-width:104px !important; min-height:44px !important; padding:8px 12px !important; white-space:nowrap !important; }\n  .dev-unified-header .dev-tools-menu { min-width:0 !important; width:auto !important; }\n  .dev-unified-header .dev-tools-menu .btn,\n  .dev-unified-header .dev-tools-menu .header-link { min-height:44px !important; white-space:normal !important; color:#fff !important; }\n}\n`;
}
