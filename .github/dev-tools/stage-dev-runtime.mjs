...
import { patchMsScheduleCompletionV4 } from "./patch-ms-schedule-completion-v4.mjs";
...
export function patchDevUiShellSource(source, currentPage) {
  ...
  if (!output.includes("DEV_TOOLS_SAFE_EMPTY_V7")) {
