...
test('Proof V16.05 keeps quick-day controls inside the date field', () => {
  assert.match(ui, /const VERSION = '20260907-05'/);
  ...
  assert.match(ui, /#day-filter\{height:40px!important;min-height:40px!important\}/);
});
...
test('Turso loader and served V16 asset use the same cache-buster', () => {
  assert.match(loader, /proof-v16\.js\?v=20260907-05/);
