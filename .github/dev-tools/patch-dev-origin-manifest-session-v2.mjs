...
async function selfTest() {
  ...
  assert.ok(patchedOrigin.includes("Session หมดอายุ · อัปโหลด HAR ใหม่ที่ข้อ 5"));
