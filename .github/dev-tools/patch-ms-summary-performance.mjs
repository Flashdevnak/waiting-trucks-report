...
export function patchMsSummaryPerformanceStyle(source) {
  ...
  if (!output.includes(PROOF_MOBILE_HEADER_MARKER)) {
    output = `${output.trimEnd()}\n\n${PROOF_MOBILE_HEADER_MARKER}\n@media (max-width:700px){body.proof-page .dev-unified-header{position:relative!important;overflow:visible!important}body.proof-page .dev-unified-header .site-header-inner,body.proof-page .dev-unified-header .dev-unified-actions,body.proof-page .dev-unified-header .dev-shell-slot,body.proof-page .dev-unified-header .app-nav{position:static!important}body.proof-page .dev-unified-header .site-header-inner,body.proof-page .dev-unified-header .dev-unified-actions{overflow:visible!important}body.proof-page .dev-unified-header .app-nav{width:100%!important;min-width:0!important}body.proof-page .dev-unified-header .app-nav-menu{position:absolute!important;left:10px!important;right:10px!important;top:calc(100% + 6px)!important;bottom:auto!important;width:auto!important;max-width:none!important;max-height:calc(100dvh - 235px)!important;margin:0!important;overflow-y:auto!important;overflow-x:hidden!important;overscroll-behavior:contain!important;z-index:999!important}}\n`;
  }
